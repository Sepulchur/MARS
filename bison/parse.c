...
#line 1 "bison/parse.y" /* yacc.c:339  */
...
#line 130 "bison/parse.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "parse.h".  */
#ifndef YY_YY_BISON_PARSE_H_INCLUDED
# define YY_YY_BISON_PARSE_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 67 "bison/parse.y" /* yacc.c:355  */
...
#line 271 "bison/parse.c" /* yacc.c:355  */
};
...
#endif /* !YY_YY_BISON_PARSE_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 288 "bison/parse.c" /* yacc.c:358  */
...
static const yytype_uint16 yyrline[] =
{
     ...
     182,   191,   200,   209,   218,   229,   240,   246,   252,   258,
     264,   264,   285,   285,   301,   305,   306,   312,   325,   343,
     362,   380,   398,   404,   408,   403,   450,   451,   452,   453,
     454,   458,   499,   527,   538,   542,   543,   550,   551,   555,
     556,   570,   579,   580,   584,   594,   603,   604,   605,   624,
     636,   650,   656,   672,   681,   680,   692,   711,   712,   691,
     741,   753,   754,   740,   771,   772,   773,   774,   775,   776,
     779,   780,   814,   850,   852,   855,   871,   875,   883,   891,
     898,   917,   931,   949,   948,   971,   970,   983,   982
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PERIOD", "DOUBLE_PERIOD", "$accept", "program", "stmt", "$@1", "$@2",
  "list_of_stmts", "expr", "$@3", "$@4", "term", "assignexpr", "$@5",
  "$@6", "primary", "lvalue", "member", "call", "callsufix", "normallcall",
  "methodcall", "elist", "objectdef", "indexed", "indexedelem", "block",
  "$@7", "funcdef", "@8", "$@9", "$@10", "@11", "$@12", "$@13", "const",
  "idlist", "N", "M", "ifprefix", "ifstmt", "elseprefix", "whilestart",
  "whilecond", "whilestmt", "forprefix", "forstmt", "$@14", "returnstmt",
  "$@15", "$@16", YY_NULLPTR
};
#endif
...
{
       0,    49,     0,     3,     4,     5,     6,     7,     9,    10,
      11,    12,    13,    15,    17,    18,    19,    20,    21,    24,
      30,    31,    36,    38,    40,    42,    45,    50,    54,    57,
      58,    61,    62,    63,    64,    69,    72,    74,    81,    85,
      86,    88,    90,    91,    92,    94,    40,    47,    65,    66,
      67,    40,    40,    95,    96,    51,    52,    54,     3,     3,
      78,    54,    40,    62,    64,    62,    73,    36,    54,    68,
      70,    71,    54,    74,     3,    14,    16,    23,    24,    25,
      26,    27,    28,    29,    32,    33,    34,    35,    42,    30,
      31,    38,    46,    59,    38,    40,    46,    50,    40,    89,
      83,    68,     3,    54,    68,    54,    42,    42,    42,    75,
      40,    74,    50,    53,    54,    39,    43,    39,    43,    41,
      41,    55,    56,    54,    54,    54,    54,    54,    54,    54,
      54,    54,    54,    54,    54,     3,    22,    54,    68,     3,
       8,    87,    54,    50,    68,    41,    40,    41,    42,    42,
      40,    79,    41,    53,    37,    44,    54,    71,    40,    84,
      84,    39,    60,    39,    41,    50,    41,    41,    68,    84,
      76,     3,    82,    54,    68,    54,    54,    54,    93,    41,
      54,    82,    41,    43,    37,    41,    83,    42,    41,    80,
       3,    50,    77,    72,    83,    72
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      50,    52,    50,    50,    50,    50,    53,    53,    54,    54,
      54,    54,    54,    54,    54,    54,    54,    54,    54,    54,
      55,    54,    56,    54,    54,    57,    57,    57,    57,    57,
      57,    57,    57,    59,    60,    58,    61,    61,    61,    61,
      61,    62,    62,    62,    62,    63,    63,    63,    63,    64,
      64,    64,    65,    65,    66,    67,    68,    68,    68,    69,
      69,    70,    70,    71,    73,    72,    75,    76,    77,    74,
      78,    79,    80,    74,    81,    81,    81,    81,    81,    81,
      82,    82,    82,    83,    84,    85,    86,    86,    87,    88,
      89,    90,    91,    93,    92,    95,    94,    96,    94
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 130 "bison/parse.y" /* yacc.c:1646  */
    {
      resettemp(); 
      (yyval.enode)=NULL;
      if(emits == 1){ //dritsas
...
#line 1588 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 5:
#line 142 "bison/parse.y" /* yacc.c:1646  */
    {resettemp(); (yyval.enode)=NULL;}
#line 1594 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 6:
#line 143 "bison/parse.y" /* yacc.c:1646  */
    {resettemp(); (yyval.enode)=NULL;}
#line 1600 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 7:
#line 144 "bison/parse.y" /* yacc.c:1646  */
    {resettemp(); (yyval.enode)=NULL;}
#line 1606 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 8:
#line 145 "bison/parse.y" /* yacc.c:1646  */
    {resettemp(); (yyval.enode)=NULL;}
#line 1612 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 9:
#line 147 "bison/parse.y" /* yacc.c:1646  */
    {
      if(!loopcounter){yyerror("Use of 'break' while not in a loop");}
    }
#line 1620 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 10:
#line 151 "bison/parse.y" /* yacc.c:1646  */
    {
      emit(jump, newexpr_constnum(0), NULL, NULL, currQuad, yylineno);
    }
#line 1628 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 11:
#line 155 "bison/parse.y" /* yacc.c:1646  */
    {
      if(!loopcounter){yyerror("Use of 'continue' while not in a loop");}
    }
#line 1636 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 12:
#line 159 "bison/parse.y" /* yacc.c:1646  */
    {
      emit(jump, newexpr_constnum(0), NULL, NULL, currQuad, yylineno);
    }
#line 1644 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 13:
#line 162 "bison/parse.y" /* yacc.c:1646  */
    {resettemp(); (yyval.enode)=NULL;}
#line 1650 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 14:
#line 163 "bison/parse.y" /* yacc.c:1646  */
    {resettemp(); (yyval.enode)=NULL;}
#line 1656 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 15:
#line 164 "bison/parse.y" /* yacc.c:1646  */
    {resettemp(); (yyval.enode)=NULL;}
#line 1662 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 16:
#line 167 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = (yyvsp[-1].enode);}
#line 1668 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 17:
#line 168 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = NULL;}
#line 1674 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 18:
#line 172 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode)=(yyvsp[0].enode);}
#line 1680 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 19:
#line 174 "bison/parse.y" /* yacc.c:1646  */
    { 
...
#line 1693 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 20:
#line 183 "bison/parse.y" /* yacc.c:1646  */
    { 
      if(expr_checkType((yyvsp[-2].enode), (yyvsp[0].enode))){ 
        (yyval.enode) = newexpr(arithexpr_e); 
        (yyval.enode)->type = expr_retType((yyval.enode),(yyvsp[-2].enode),(yyvsp[0].enode));
...
#line 1706 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 21:
#line 192 "bison/parse.y" /* yacc.c:1646  */
    { 
      if(expr_checkType((yyvsp[-2].enode), (yyvsp[0].enode))){ 
        (yyval.enode) = newexpr(arithexpr_e); 
        (yyval.enode)->type = expr_retType((yyval.enode),(yyvsp[-2].enode),(yyvsp[0].enode));
...
#line 1719 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 22:
#line 201 "bison/parse.y" /* yacc.c:1646  */
    { 
      if(expr_checkType((yyvsp[-2].enode), (yyvsp[0].enode))){ 
        (yyval.enode) = newexpr(arithexpr_e); 
        (yyval.enode)->type = expr_retType((yyval.enode),(yyvsp[-2].enode),(yyvsp[0].enode));
...
#line 1732 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 23:
#line 210 "bison/parse.y" /* yacc.c:1646  */
    { 
      if(expr_checkType((yyvsp[-2].enode), (yyvsp[0].enode))){ 
        (yyval.enode) = newexpr(arithexpr_e); 
        (yyval.enode)->type = expr_retType((yyval.enode),(yyvsp[-2].enode),(yyvsp[0].enode));
...
#line 1745 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 24:
#line 219 "bison/parse.y" /* yacc.c:1646  */
    {
      emits = 0;
      backPatch((yyvsp[-2].enode)->falseList, nextquadlabel()+2);
      emit(assign, (yyvsp[-2].enode), newexpr_constbool(1), NULL, currQuad, yylineno);
      emit(jump, newexpr_constnum(0), NULL, NULL, nextquadlabel()+2, yylineno);
      emit(assign, (yyvsp[-2].enode), newexpr_constbool(0), NULL, currQuad, yylineno);
      (yyval.enode) = newexpr(boolexpr_e);  
      (yyval.enode)->sym = returnTempName((yyvsp[-2].enode),(yyvsp[0].enode),table); 
      (yyval.enode) = relopEmit((yyval.enode), (yyvsp[-2].enode), (yyvsp[0].enode), if_eq, yylineno);  
    }
#line 1760 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 25:
#line 230 "bison/parse.y" /* yacc.c:1646  */
    {
      emits = 0;
      backPatch((yyvsp[-2].enode)->falseList, nextquadlabel()+2);
      emit(assign, (yyvsp[-2].enode), newexpr_constbool(1), NULL, currQuad, yylineno);
...
#line 1775 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 26:
#line 241 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode) = newexpr(boolexpr_e);  
      (yyval.enode)->sym = returnTempName((yyvsp[-2].enode),(yyvsp[0].enode),table); 
      (yyval.enode) = relopEmit((yyval.enode), (yyvsp[-2].enode), (yyvsp[0].enode), if_greater, yylineno);
    }
#line 1785 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 27:
#line 247 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode) = newexpr(boolexpr_e);  
      (yyval.enode)->sym = returnTempName((yyvsp[-2].enode),(yyvsp[0].enode),table); 
      (yyval.enode) = relopEmit((yyval.enode), (yyvsp[-2].enode), (yyvsp[0].enode), if_less, yylineno); 
    }
#line 1795 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 28:
#line 253 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode) = newexpr(boolexpr_e);
      (yyval.enode)->sym = returnTempName((yyvsp[-2].enode),(yyvsp[0].enode),table); 
      (yyval.enode) = relopEmit((yyval.enode), (yyvsp[-2].enode), (yyvsp[0].enode), if_greatereq, yylineno);
    }
#line 1805 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 29:
#line 259 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode) = newexpr(boolexpr_e); 
      (yyval.enode)->sym = returnTempName((yyvsp[-2].enode),(yyvsp[0].enode),table); 
      (yyval.enode) = relopEmit((yyval.enode), (yyvsp[-2].enode), (yyvsp[0].enode), if_lesseq, yylineno); 
    }
#line 1815 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 30:
#line 264 "bison/parse.y" /* yacc.c:1646  */
    {logicEmit((yyvsp[-1].enode),yylineno);}
#line 1821 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 31:
#line 265 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode) = newexpr(boolexpr_e);  
...
#line 1846 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 32:
#line 285 "bison/parse.y" /* yacc.c:1646  */
    {logicEmit((yyvsp[-1].enode), yylineno);}
#line 1852 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 33:
#line 286 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode) = newexpr(boolexpr_e);  
      (yyval.enode)->sym = returnTempName((yyvsp[-4].enode), (yyvsp[0].enode), table); 
      logicEmit((yyvsp[0].enode), yylineno);
...
#line 1872 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 34:
#line 301 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode)=(yyvsp[0].enode);}
#line 1878 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 35:
#line 305 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode)=(yyvsp[-1].enode);}
#line 1884 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 36:
#line 307 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode) = newexpr(arithexpr_e); 
      (yyval.enode)->sym = newtemp(table,0); 
      emit(uminus, (yyval.enode), (yyvsp[0].enode), NULL, currQuad, yylineno);
    }
#line 1894 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 37:
#line 313 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode)=newexpr(boolexpr_e); 
      (yyval.enode)->sym = newtemp(table,0); 
...
#line 1911 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 38:
#line 326 "bison/parse.y" /* yacc.c:1646  */
    {
...
#line 1933 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 39:
#line 344 "bison/parse.y" /* yacc.c:1646  */
    {
      SymbolTableEntry_t *t = H_Lookup(table, -1, temp_lvalue->content);
      if(t != NULL && t->type > 3){
        yyerror("Cannot increment function value\n");
...
#line 1956 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 40:
#line 363 "bison/parse.y" /* yacc.c:1646  */
    {
      SymbolTableEntry_t *t = H_Lookup(table, -1, temp_lvalue->content);
      if(t != NULL && t->type > 3){
...
#line 1978 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 41:
#line 381 "bison/parse.y" /* yacc.c:1646  */
    {
      SymbolTableEntry_t *t = H_Lookup(table, -1, temp_lvalue->content);
      if(t != NULL && t->type > 3){
        yyerror("Cannot decrement function value\n");
...
#line 2000 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 42:
#line 398 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode)=(yyvsp[0].enode);}
#line 2006 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 43:
#line 404 "bison/parse.y" /* yacc.c:1646  */
    {
      /*$1 = lvalue_expr(temp_test); */
    }
#line 2014 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 44:
#line 408 "bison/parse.y" /* yacc.c:1646  */
    {
      lassignl=true;
    }
#line 2022 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 45:
#line 412 "bison/parse.y" /* yacc.c:1646  */
    {
      if(emits ==1){ //dritsas
...
#line 2062 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 46:
#line 450 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = (yyvsp[0].enode);}
#line 2068 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 47:
#line 451 "bison/parse.y" /* yacc.c:1646  */
    {}
#line 2074 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 48:
#line 452 "bison/parse.y" /* yacc.c:1646  */
    {}
#line 2080 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 49:
#line 453 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = (yyvsp[-1].enode);}
#line 2086 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 50:
#line 454 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = (yyvsp[0].enode);}
#line 2092 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 51:
#line 459 "bison/parse.y" /* yacc.c:1646  */
    {
      temp_lvalue = temp;
...
#line 2137 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 52:
#line 500 "bison/parse.y" /* yacc.c:1646  */
    {
      local = true;
      temp_lvalue=temp;
      SymbolTableEntry_t *new;
...
#line 2169 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 53:
#line 528 "bison/parse.y" /* yacc.c:1646  */
    {
      temp_lvalue=temp;
...
#line 2184 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 54:
#line 538 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = (yyvsp[0].enode);}
#line 2190 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 55:
#line 542 "bison/parse.y" /* yacc.c:1646  */
    {if((yyvsp[-2].enode) != NULL){(yyval.enode) = member_item((yyvsp[-2].enode), (yyvsp[0].strVal), table , yylineno);}}
#line 2196 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 56:
#line 544 "bison/parse.y" /* yacc.c:1646  */
    { 
...
#line 2207 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 57:
#line 550 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = NULL;}
#line 2213 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 58:
#line 551 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = NULL;}
#line 2219 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 59:
#line 555 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = make_call((yyvsp[-3].enode), (yyvsp[-1].enode), table, yylineno);}
#line 2225 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 60:
#line 557 "bison/parse.y" /* yacc.c:1646  */
    {
...
#line 2243 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 61:
#line 571 "bison/parse.y" /* yacc.c:1646  */
    {
			expr* func = newexpr(programfunc_e);
			func->sym = (yyvsp[-4].enode)->sym;
			(yyval.enode) = make_call(func, (yyvsp[-1].enode),table, yylineno);
		}
#line 2253 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 62:
#line 579 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = (yyvsp[0].enode);}
#line 2259 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 63:
#line 580 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = (yyvsp[0].enode);}
#line 2265 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 64:
#line 585 "bison/parse.y" /* yacc.c:1646  */
    {	
...
#line 2276 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 65:
#line 595 "bison/parse.y" /* yacc.c:1646  */
    {
			(yyval.enode) = newexpr(tableitem_e);
			(yyval.enode)->next = (yyvsp[-1].enode);
...
#line 2287 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 66:
#line 603 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = NULL;}
#line 2293 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 67:
#line 604 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = (yyvsp[0].enode);}
#line 2299 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 68:
#line 606 "bison/parse.y" /* yacc.c:1646  */
    {
...
#line 2318 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 69:
#line 625 "bison/parse.y" /* yacc.c:1646  */
    {
      int i = 0;
...
#line 2334 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 70:
#line 637 "bison/parse.y" /* yacc.c:1646  */
    {
      expr *node = newexpr(newtable_e);
			node->sym = newtemp(table,0);
			emit(tablecreate, node, NULL, NULL, currQuad, yylineno);
...
#line 2349 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 71:
#line 651 "bison/parse.y" /* yacc.c:1646  */
    { 
      expr *node = (yyvsp[0].enode);
      node->next = NULL; 
      (yyval.enode) = node;
    }
#line 2359 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 72:
#line 657 "bison/parse.y" /* yacc.c:1646  */
    {
      expr *node = (yyvsp[0].enode);
...
#line 2376 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 73:
#line 673 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.enode) = (yyvsp[-1].enode);
      (yyval.enode)->index = (yyvsp[-3].enode);
    }
#line 2385 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 74:
#line 681 "bison/parse.y" /* yacc.c:1646  */
    {
      enterScope();
    }
#line 2393 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 75:
#line 685 "bison/parse.y" /* yacc.c:1646  */
    {
      exitScope(table);
    }
#line 2401 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 76:
#line 692 "bison/parse.y" /* yacc.c:1646  */
    {
      functionDepth++;
...
#line 2425 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 77:
#line 711 "bison/parse.y" /* yacc.c:1646  */
    {enterscopespace();}
#line 2431 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 78:
#line 712 "bison/parse.y" /* yacc.c:1646  */
    {
        enterscopespace(); 
...
#line 2452 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 79:
#line 729 "bison/parse.y" /* yacc.c:1646  */
    {
      functionDepth--;
 			exitscopespace(); 
      exitscopespace();
...
#line 2468 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 80:
#line 741 "bison/parse.y" /* yacc.c:1646  */
    {
      functionDepth++;
...
#line 2485 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 81:
#line 753 "bison/parse.y" /* yacc.c:1646  */
    {enterscopespace();}
#line 2491 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 82:
#line 754 "bison/parse.y" /* yacc.c:1646  */
    {
      enterscopespace(); 
    }
#line 2499 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 83:
#line 758 "bison/parse.y" /* yacc.c:1646  */
    {
      functionDepth--;
      exitscopespace(); 
      exitscopespace();
...
#line 2514 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 84:
#line 771 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = newexpr_constnum(yylval.intVal);}
#line 2520 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 85:
#line 772 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = newexpr_constnum(yylval.floatVal);}
#line 2526 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 86:
#line 773 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = newexpr_conststring(yylval.strVal);}
#line 2532 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 87:
#line 774 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = newexpr(nil_e);}
#line 2538 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 88:
#line 775 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = newexpr_constbool(1);}
#line 2544 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 89:
#line 776 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.enode) = newexpr_constbool(0);}
#line 2550 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 91:
#line 781 "bison/parse.y" /* yacc.c:1646  */
    {
...
#line 2588 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 92:
#line 815 "bison/parse.y" /* yacc.c:1646  */
    {
      passport_t v = createPassport(temp->content, currentScope+1); 
      if(error_symbol == NULL){
        if(AL_Insert(&temp_symbol->argList, v) == NULL){
...
#line 2626 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 93:
#line 850 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.intVal) = nextquadlabel();emit(jump, newexpr_constnum(0), NULL, NULL, 0, yylineno);}
#line 2632 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 94:
#line 852 "bison/parse.y" /* yacc.c:1646  */
    {(yyval.intVal) = nextquadlabel();}
#line 2638 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 95:
#line 856 "bison/parse.y" /* yacc.c:1646  */
    {
      if(emits){
        backPatch((yyvsp[-1].enode)->falseList, nextquadlabel()+2);
        emit(assign, (yyvsp[-1].enode), newexpr_constbool(1), NULL, currQuad, yylineno);
...
#line 2655 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 96:
#line 872 "bison/parse.y" /* yacc.c:1646  */
    {
      patchlabel((yyvsp[-1].intVal), nextquad());
    }
#line 2663 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 97:
#line 876 "bison/parse.y" /* yacc.c:1646  */
    {
      patchlabel((yyvsp[-3].intVal), (yyvsp[-1].intVal) + 1);
      patchlabel((yyvsp[-1].intVal), nextquad());
    }
#line 2672 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 98:
#line 884 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.intVal) = nextquadlabel();
      emit(jump, newexpr_constnum(0), NULL, NULL, 0, yylineno);
    }
#line 2681 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 99:
#line 892 "bison/parse.y" /* yacc.c:1646  */
    {
      (yyval.intVal) = nextquadlabel();
    }
#line 2689 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 100:
#line 899 "bison/parse.y" /* yacc.c:1646  */
    {
      if(emits){
        backPatch((yyvsp[-1].enode)->falseList, nextquadlabel()+2);
        emit(assign, (yyvsp[-1].enode), newexpr_constbool(1), NULL, currQuad, yylineno);
...
#line 2709 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 101:
#line 918 "bison/parse.y" /* yacc.c:1646  */
    { 
      --loopcounter;
...
#line 2724 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 102:
#line 932 "bison/parse.y" /* yacc.c:1646  */
    {
      if(emits){
        backPatch((yyvsp[-1].enode)->falseList, nextquadlabel()+2);
        emit(assign, (yyvsp[-1].enode), newexpr_constbool(1), NULL, currQuad, yylineno);
...
#line 2742 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 103:
#line 949 "bison/parse.y" /* yacc.c:1646  */
    { 
      ++loopcounter;
			push(breakstacklist, 0);
      push(contstacklist, 0); 
		}
#line 2752 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 104:
#line 955 "bison/parse.y" /* yacc.c:1646  */
    {
			--loopcounter; 
...
#line 2769 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 105:
#line 971 "bison/parse.y" /* yacc.c:1646  */
    {
			if(!functionDepth){
        yyerror("expected identifier or '(' before 'return'");
      }
    }
#line 2779 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 106:
#line 977 "bison/parse.y" /* yacc.c:1646  */
    { 
      emit(ret, (yyvsp[-1].enode), NULL, NULL, currQuad, yylineno); 
      retLabel = currQuad ; 
      emit(jump , newexpr_constnum(0) , NULL  , NULL , currQuad ,yylineno);
    }
#line 2789 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 107:
#line 983 "bison/parse.y" /* yacc.c:1646  */
    {
      if(!functionDepth){
        yyerror("expected identifier or '(' before 'return'");
      }
    }
#line 2799 "bison/parse.c" /* yacc.c:1646  */
    break;

  case 108:
#line 989 "bison/parse.y" /* yacc.c:1646  */
    {
      emit(ret, NULL, NULL, NULL, currQuad, yylineno);
      retLabel = currQuad ; 
      emit(jump , newexpr_constnum(0) , NULL  , NULL , currQuad ,yylineno);      
    }
#line 2809 "bison/parse.c" /* yacc.c:1646  */
    break;


#line 2813 "bison/parse.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 995 "bison/parse.y" /* yacc.c:1906  */
